...
export const topNavItems = [
  ...
  { key: "products", label: "AI 商品智库", href: "/products", match: (pathname) => pathname.startsWith("/products") },
...
export const routeMeta = {
  ...
  "/products": { label: "AI 商品智库", section: "AI 商品智库", status: "prototype" },
  "/products/new": { label: "商品学习", section: "AI 商品智库", status: "prototype" },
  "/products/[id]": { label: "商品详情", section: "AI 商品智库", status: "prototype" },
