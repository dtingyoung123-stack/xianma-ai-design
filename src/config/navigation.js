...
export const topNavItems = [
  ...
  { key: "products", label: "商品智库", href: "/products", match: (pathname) => pathname.startsWith("/products") },
...
export const navGroups = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "buyer-show-agent", label: "AI 买家秀 Agent", href: "/ai-hub/buyer-show-agent", badge: "NEW" },
      { key: "detail-refresh", label: "AI 商详焕新", href: "/ai-hub/detail-refresh", badge: "NEW" },
...
export const routeMeta = {
  ...
  "/ai-hub/buyer-show-agent": { label: "AI 买家秀 Agent", section: "AI 能力中心", status: "prototype" },
  "/ai-hub/detail-refresh": { label: "AI 商详焕新", section: "AI 能力中心", status: "prototype" },
  ...
  "/products": { label: "商品智库", section: "商品智库", status: "prototype" },
  "/products/new": { label: "商品学习", section: "商品智库", status: "prototype" },
  "/products/[id]": { label: "商品详情", section: "商品智库", status: "prototype" },
